...
{
public:
	WeatherTask(const std::vector<std::string>& cities, std::unique_ptr<IHttpPoller> poller, std::unique_ptr<ITimer> timer, std::shared_ptr<IDatabaseEngine> databaseEngine);
protected:
